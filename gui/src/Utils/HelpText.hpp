...
namespace zappy::constants {
    ...
    inline const char *HELP_TITLE = "HELP";

    inline const char *HELP_SECTION_1 = "Game Overview";

    inline const char *HELP_SECTION_1_CONTENT = "Zappy is a game where AI-controlled players compete to collect resources\n"
    ...
    inline const char *HELP_SECTION_2 = "Controls";

    inline const char *HELP_SECTION_2_CONTENT = "Camera Movement:\n"
    ...
    inline const char *HELP_SECTION_3 = "Teams and Players";

    inline const char *HELP_SECTION_3_CONTENT = "The left panel shows all teams and their player IDs.\n"
                                                "Players have different levels based on collected resources.\n"
                                                "The team that first gets a player to level 8 wins the game.";

    inline const char *HELP_SECTION_4 = "Resources";

    inline const char *HELP_SECTION_4_CONTENT = "Resources on the map are represented by different colored objects.\n"
